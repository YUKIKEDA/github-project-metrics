...
/**
 * PlanVsActualMetric と ReviewTimeMetric のスピアマン相関係数を計算します。
 * planned フィールドを使用します。
 *
 ...
 */
export function calculatePlanVsActualVsReviewTimeCorrelationSpearman(planVsActuals, reviewTimes) {
    ...
    try {
        return correlationSpearman(plannedValues, reviewTimeValues);
    }
    catch {
        return undefined;
    }
