...
/**
 * CommentCountMetric と ReviewTimeMetric のスピアマン相関係数を計算します。
 *
 ...
 */
export function calculateCommentVsReviewTimeCorrelationSpearman(comments, reviewTimes) {
    ...
    try {
        return correlationSpearman(commentValues, reviewTimeValues);
    }
    catch {
        return undefined;
    }
