...
/**
 * ComplexityMetric と CycleTimeMetric のスピアマン相関係数を計算します。
 *
 ...
 */
export function calculateComplexityVsCycleTimeCorrelationSpearman(complexities, cycleTimes) {
    ...
    try {
        return correlationSpearman(complexityValues, cycleTimeValues);
    }
    catch {
        return undefined;
    }
