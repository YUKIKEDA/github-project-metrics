...
/**
 * CommentCountMetric と ComplexityMetric のピアソン相関係数を計算します。
 *
 ...
 */
export function calculateCommentVsComplexityCorrelationPearson(comments, complexities) {
    ...
    try {
        return correlationPearson(commentValues, complexityValues);
    }
    catch {
        return undefined;
    }
