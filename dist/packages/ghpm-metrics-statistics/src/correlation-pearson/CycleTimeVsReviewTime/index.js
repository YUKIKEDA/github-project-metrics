...
/**
 * CycleTimeMetric と ReviewTimeMetric のピアソン相関係数を計算します。
 *
 ...
 */
export function calculateCycleTimeVsReviewTimeCorrelationPearson(cycleTimes, reviewTimes) {
    ...
    try {
        return correlationPearson(cycleTimeValues, reviewTimeValues);
    }
    catch {
        return undefined;
    }
