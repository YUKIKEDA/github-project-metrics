...
/**
 * ComplexityMetric と PlanVsActualMetric のピアソン相関係数を計算します。
 * planned フィールドを使用します。
 *
 ...
 */
export function calculateComplexityVsPlanVsActualCorrelationPearson(complexities, planVsActuals) {
    ...
    try {
        return correlationPearson(complexityValues, plannedValues);
    }
    catch {
        return undefined;
    }
