 ...
 */
export async function fetchAllProjectData(context) {
    ...
    try {
        ...
        while (true) {
            ...
            if (ownerType === "Organization") {
                ...
                const response = await client.graphql(ORGANIZATION_PROJECT_V2_GRAPHQL, variables);
                ...
                const response = await client.graphql(USER_PROJECT_V2_GRAPHQL, variables);
