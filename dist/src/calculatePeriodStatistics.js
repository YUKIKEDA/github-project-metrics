...
import { calculateCommentCountMean, calculateCommentCountMedian, calculateCommentCountMode, calculateCommentCountMax, calculateCommentCountMin, calculateCommentCountVariance, calculateCommentCountStandardDeviation, calculateCommentCountInterquartileRange, calculateCommentCountKurtosis, calculateCommentCountSkewness, calculateCommentCountPercentile, calculateCommentCountOutliersIQR, calculateCommentCountOutliersZScore, calculateComplexityMean, calculateComplexityMedian, calculateComplexityMode, calculateComplexityMax, calculateComplexityMin, calculateComplexityVariance, calculateComplexityStandardDeviation, calculateComplexityInterquartileRange, calculateComplexityKurtosis, calculateComplexitySkewness, calculateComplexityPercentile, calculateComplexityOutliersIQR, calculateComplexityOutliersZScore, calculateCycleTimeMean, calculateCycleTimeMedian, calculateCycleTimeMode, calculateCycleTimeMax, calculateCycleTimeMin, calculateCycleTimeVariance, calculateCycleTimeStandardDeviation, calculateCycleTimeInterquartileRange, calculateCycleTimeKurtosis, calculateCycleTimeSkewness, calculateCycleTimePercentile, calculateCycleTimeOutliersIQR, calculateCycleTimeOutliersZScore, calculateLeadTimeMean, calculateLeadTimeMedian, calculateLeadTimeMode, calculateLeadTimeMax, calculateLeadTimeMin, calculateLeadTimeVariance, calculateLeadTimeStandardDeviation, calculateLeadTimeInterquartileRange, calculateLeadTimeKurtosis, calculateLeadTimeSkewness, calculateLeadTimePercentile, calculateLeadTimeOutliersIQR, calculateLeadTimeOutliersZScore, calculatePlanVsActualMean, calculatePlanVsActualMedian, calculatePlanVsActualMode, calculatePlanVsActualMax, calculatePlanVsActualMin, calculatePlanVsActualVariance, calculatePlanVsActualStandardDeviation, calculatePlanVsActualInterquartileRange, calculatePlanVsActualKurtosis, calculatePlanVsActualSkewness, calculatePlanVsActualPercentile, calculatePlanVsActualOutliersIQR, calculatePlanVsActualOutliersZScore, calculateReviewTimeMean, calculateReviewTimeMedian, calculateReviewTimeMode, calculateReviewTimeMax, calculateReviewTimeMin, calculateReviewTimeVariance, calculateReviewTimeStandardDeviation, calculateReviewTimeInterquartileRange, calculateReviewTimeKurtosis, calculateReviewTimeSkewness, calculateReviewTimePercentile, calculateReviewTimeOutliersIQR, calculateReviewTimeOutliersZScore, calculateCommentVsComplexityCorrelationPearson, calculateCommentVsComplexityCorrelationSpearman, calculateCommentVsCycleTimeCorrelationPearson, calculateCommentVsCycleTimeCorrelationSpearman, calculateCommentVsLeadTimeCorrelationPearson, calculateCommentVsLeadTimeCorrelationSpearman, calculateCommentVsPlanVsActualCorrelationPearson, calculateCommentVsPlanVsActualCorrelationSpearman, calculateCommentVsReviewTimeCorrelationPearson, calculateCommentVsReviewTimeCorrelationSpearman, calculateComplexityVsCycleTimeCorrelationPearson, calculateComplexityVsCycleTimeCorrelationSpearman, calculateComplexityVsLeadTimeCorrelationPearson, calculateComplexityVsLeadTimeCorrelationSpearman, calculateComplexityVsPlanVsActualCorrelationPearson, calculateComplexityVsPlanVsActualCorrelationSpearman, calculateComplexityVsReviewTimeCorrelationPearson, calculateComplexityVsReviewTimeCorrelationSpearman, calculateCycleTimeVsLeadTimeCorrelationPearson, calculateCycleTimeVsLeadTimeCorrelationSpearman, calculateCycleTimeVsPlanVsActualCorrelationPearson, calculateCycleTimeVsPlanVsActualCorrelationSpearman, calculateCycleTimeVsReviewTimeCorrelationPearson, calculateCycleTimeVsReviewTimeCorrelationSpearman, calculateLeadTimeVsPlanVsActualCorrelationPearson, calculateLeadTimeVsPlanVsActualCorrelationSpearman, calculateLeadTimeVsReviewTimeCorrelationPearson, calculateLeadTimeVsReviewTimeCorrelationSpearman, calculatePlanVsActualVsReviewTimeCorrelationPearson, calculatePlanVsActualVsReviewTimeCorrelationSpearman, } from "@github-project-metrics/ghpm-metrics-statistics";
/**
 * 期間の種類からミリ秒単位の期間を取得する。
 */
function getPeriodDurationMs(periodType) {
    switch (periodType) {
        case "1week":
 ...
 * @returns 期間ごとの統計計算結果
 */
export function calculatePeriodStatistics(input) {
    ...
    for (const issueMetric of issueMetrics) {
        ...
        const periodStart = new Date(Math.floor(createdAt.getTime() / periodDurationMs) * periodDurationMs);
 ...
 * 期間内のメトリクスから統計を計算する。
 */
function calculateStatisticsForPeriod(metrics) {
    // 各メトリクスを抽出
...
//# sourceMappingURL=calculatePeriodStatistics.js.map