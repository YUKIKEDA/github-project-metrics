...
import { calculateComplexityStandardDeviation } from "./index.js";

describe("calculateComplexityStandardDeviation", () => {
  it("複数のメトリクスから estimated の標準偏差を計算する", () => {
    ...
    const result = calculateComplexityStandardDeviation(metrics);
