...
import { calculateLeadTimeStandardDeviation } from "./index.js";

describe("calculateLeadTimeStandardDeviation", () => {
  it("複数のメトリクスから durationMs の標準偏差を計算する", () => {
    ...
    const result = calculateLeadTimeStandardDeviation(metrics);
