...
import { calculateLeadTimeVsPlanVsActualCorrelationPearson } from "./index.js";

describe("calculateLeadTimeVsPlanVsActualCorrelationPearson", () => {
  it("複数のメトリクスから相関係数を計算する", () => {
    ...
    const result = calculateLeadTimeVsPlanVsActualCorrelationPearson(leadTimes, planVsActuals);
