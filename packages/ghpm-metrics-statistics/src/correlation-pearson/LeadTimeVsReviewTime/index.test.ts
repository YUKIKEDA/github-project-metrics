...
import { calculateLeadTimeVsReviewTimeCorrelationPearson } from "./index.js";

describe("calculateLeadTimeVsReviewTimeCorrelationPearson", () => {
  it("複数のメトリクスから相関係数を計算する", () => {
    ...
    const result = calculateLeadTimeVsReviewTimeCorrelationPearson(leadTimes, reviewTimes);
