...
import { calculateCycleTimeVsReviewTimeCorrelationPearson } from "./index.js";

describe("calculateCycleTimeVsReviewTimeCorrelationPearson", () => {
  it("複数のメトリクスから相関係数を計算する", () => {
    ...
    const result = calculateCycleTimeVsReviewTimeCorrelationPearson(cycleTimes, reviewTimes);
