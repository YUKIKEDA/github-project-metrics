...
import { calculateCommentVsPlanVsActualCorrelationPearson } from "./index.js";

describe("calculateCommentVsPlanVsActualCorrelationPearson", () => {
  it("複数のメトリクスから相関係数を計算する", () => {
    ...
    const result = calculateCommentVsPlanVsActualCorrelationPearson(comments, planVsActuals);
