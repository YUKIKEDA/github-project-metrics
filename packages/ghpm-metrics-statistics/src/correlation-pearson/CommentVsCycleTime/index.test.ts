...
import { calculateCommentVsCycleTimeCorrelationPearson } from "./index.js";

describe("calculateCommentVsCycleTimeCorrelationPearson", () => {
  it("複数のメトリクスから相関係数を計算する", () => {
    ...
    const result = calculateCommentVsCycleTimeCorrelationPearson(comments, cycleTimes);
