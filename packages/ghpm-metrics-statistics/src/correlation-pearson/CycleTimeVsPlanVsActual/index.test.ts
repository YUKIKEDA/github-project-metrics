...
import { calculateCycleTimeVsPlanVsActualCorrelationPearson } from "./index.js";

describe("calculateCycleTimeVsPlanVsActualCorrelationPearson", () => {
  it("複数のメトリクスから相関係数を計算する", () => {
    ...
    const result = calculateCycleTimeVsPlanVsActualCorrelationPearson(cycleTimes, planVsActuals);
