...
import { calculateCommentVsLeadTimeCorrelationPearson } from "./index.js";

describe("calculateCommentVsLeadTimeCorrelationPearson", () => {
  it("複数のメトリクスから相関係数を計算する", () => {
    ...
    const result = calculateCommentVsLeadTimeCorrelationPearson(comments, leadTimes);
