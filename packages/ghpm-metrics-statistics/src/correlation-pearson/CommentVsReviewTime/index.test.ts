...
import { calculateCommentVsReviewTimeCorrelationPearson } from "./index.js";

describe("calculateCommentVsReviewTimeCorrelationPearson", () => {
  it("複数のメトリクスから相関係数を計算する", () => {
    ...
    const result = calculateCommentVsReviewTimeCorrelationPearson(comments, reviewTimes);
