...
import { calculateReviewTimeVariance } from "./index.js";

describe("calculateReviewTimeVariance", () => {
  it("複数のメトリクスから duration の分散を計算する", () => {
    ...
    const result = calculateReviewTimeVariance(metrics);
