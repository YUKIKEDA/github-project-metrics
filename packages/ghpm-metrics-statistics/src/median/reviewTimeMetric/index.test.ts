...
import { calculateReviewTimeMedian } from "./index.js";

describe("calculateReviewTimeMedian", () => {
  it("複数のメトリクスから duration の中央値を計算する", () => {
    ...
    const result = calculateReviewTimeMedian(metrics);
