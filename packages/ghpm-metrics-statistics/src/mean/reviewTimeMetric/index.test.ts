...
import { calculateReviewTimeMean } from "./index.js";

describe("calculateReviewTimeMean", () => {
  it("複数のメトリクスから duration の平均値を計算する", () => {
    ...
    const result = calculateReviewTimeMean(metrics);

    expect(result).toEqual({
      duration: (3600000 + 7200000 + 1800000) / 3,
    });
  });
