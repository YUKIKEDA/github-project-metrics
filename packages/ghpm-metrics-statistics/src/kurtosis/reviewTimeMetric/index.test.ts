...
import { calculateReviewTimeKurtosis } from "./index.js";

describe("calculateReviewTimeKurtosis", () => {
  it("複数のメトリクスから duration の尖度を計算する", () => {
    ...
    const result = calculateReviewTimeKurtosis(metrics);
