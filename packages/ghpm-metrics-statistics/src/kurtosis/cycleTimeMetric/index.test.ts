...
import { calculateCycleTimeKurtosis } from "./index.js";

describe("calculateCycleTimeKurtosis", () => {
  it("複数のメトリクスから durationMs の尖度を計算する", () => {
    ...
    const result = calculateCycleTimeKurtosis(metrics);
