...
import { calculateReviewTimeOutliersZScore } from "./index.js";

describe("calculateReviewTimeOutliersZScore", () => {
  it("複数のメトリクスから duration の外れ値を検出する", () => {
    ...
    const result = calculateReviewTimeOutliersZScore(metrics);
