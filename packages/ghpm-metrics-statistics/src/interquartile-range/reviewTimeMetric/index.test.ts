...
import { calculateReviewTimeInterquartileRange } from "./index.js";

describe("calculateReviewTimeInterquartileRange", () => {
  it("複数のメトリクスから duration の四分位範囲を計算する", () => {
    const metrics: ReviewTimeMetric[] = [
      ...
      {
        duration: 5400000, // 1.5時間
        reviewRequestedAt: "2024-01-01T00:00:00Z",
        reviewMergedAt: "2024-01-01T01:30:00Z",
      },
    ];

    const result = calculateReviewTimeInterquartileRange(metrics);
