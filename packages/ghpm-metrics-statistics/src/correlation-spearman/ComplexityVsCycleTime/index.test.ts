...
import { calculateComplexityVsCycleTimeCorrelationSpearman } from "./index.js";

describe("calculateComplexityVsCycleTimeCorrelationSpearman", () => {
  it("複数のメトリクスから相関係数を計算する", () => {
    ...
    const result = calculateComplexityVsCycleTimeCorrelationSpearman(complexities, cycleTimes);
