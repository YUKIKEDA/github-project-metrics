...
import { calculateCommentVsComplexityCorrelationSpearman } from "./index.js";

describe("calculateCommentVsComplexityCorrelationSpearman", () => {
  it("複数のメトリクスから相関係数を計算する", () => {
    ...
    const result = calculateCommentVsComplexityCorrelationSpearman(comments, complexities);
