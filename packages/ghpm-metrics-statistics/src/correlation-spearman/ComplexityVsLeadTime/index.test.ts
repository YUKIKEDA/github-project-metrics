...
import { calculateComplexityVsLeadTimeCorrelationSpearman } from "./index.js";

describe("calculateComplexityVsLeadTimeCorrelationSpearman", () => {
  it("複数のメトリクスから相関係数を計算する", () => {
    ...
    const result = calculateComplexityVsLeadTimeCorrelationSpearman(complexities, leadTimes);
