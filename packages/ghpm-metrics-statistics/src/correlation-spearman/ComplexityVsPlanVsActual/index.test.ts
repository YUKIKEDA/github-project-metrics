...
import { calculateComplexityVsPlanVsActualCorrelationSpearman } from "./index.js";

describe("calculateComplexityVsPlanVsActualCorrelationSpearman", () => {
  it("複数のメトリクスから相関係数を計算する", () => {
    ...
    const result = calculateComplexityVsPlanVsActualCorrelationSpearman(complexities, planVsActuals);
