...
import { calculatePlanVsActualVsReviewTimeCorrelationSpearman } from "./index.js";

describe("calculatePlanVsActualVsReviewTimeCorrelationSpearman", () => {
  it("複数のメトリクスから相関係数を計算する", () => {
    ...
    const result = calculatePlanVsActualVsReviewTimeCorrelationSpearman(planVsActuals, reviewTimes);
