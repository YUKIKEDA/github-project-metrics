...
import { calculateComplexityVsReviewTimeCorrelationSpearman } from "./index.js";

describe("calculateComplexityVsReviewTimeCorrelationSpearman", () => {
  it("複数のメトリクスから相関係数を計算する", () => {
    ...
    const result = calculateComplexityVsReviewTimeCorrelationSpearman(complexities, reviewTimes);
